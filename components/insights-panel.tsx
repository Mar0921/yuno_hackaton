...
const insights = [
  {
    id: 1,
    title: "Incremento en reuniones",
    description: "34% más reuniones este mes vs. anterior",
    trend: "up",
    icon: TrendingUp,
    color: "text-chart-3",
  },
  {
    ...
    description: "15 clientes con actividad en últimos 7 días",
    trend: "neutral",
    icon: Users,
    color: "text-primary",
  },
  {
    ...
    description: "48 min por reunión (óptimo)",
    trend: "neutral",
    icon: Clock,
